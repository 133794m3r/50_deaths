...
for file in files:
	...
	#new_img = Image.new('RGBA', (img0.size[0], img0.size[1]))
	new_img = img0.convert("RGBA")
...
#		counter += 1
	...
	num_img = num_img.convert("P", palette=Image.ADAPTIVE, colors=17)
	num_img.save(f'{file}_numbered.png')
